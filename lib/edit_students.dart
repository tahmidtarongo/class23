...
class EditStudents extends StatefulWidget {
  const EditStudents({Key? key,required this.studentInformationModel}) : super(key: key);
...
class _EditStudentsState extends State<EditStudents> {
  ...
  @override
  void initState() {
    pictureUrl = widget.studentInformationModel.pictureUrl.toString();
    studentNameEditingController.text = widget.studentInformationModel.studentName.toString();
    fathersNameEditingController.text = widget.studentInformationModel.fathersName.toString();
    mothersNameEditingController.text =  widget.studentInformationModel.mothersName.toString();
    dateOfBirthEditingController.text =  widget.studentInformationModel.dateOfBirth.toString();
    rollNumberEditingController.text =  widget.studentInformationModel.rollNumber.toString();
    studentIdEditingController.text = widget.studentInformationModel.studentId.toString();
    studentInstituteEditingController.text =  widget.studentInformationModel.instituteName.toString();
    studentGroupEditingController.text =  widget.studentInformationModel.studentGroup.toString();
    studentBloodGroupEditingController.text =  widget.studentInformationModel.bloodGroup.toString();
    studentClassNameEditingController.text =  widget.studentInformationModel.className.toString();
    initialLanguage =  widget.studentInformationModel.language.toString();
    studentContactEditingController.text =  widget.studentInformationModel.emergencyContactNumber.toString();
    super.initState();
  }
                    ...
                    onPressed: () async {
                      ...
                      await dbRef.orderByKey().get().then((value) {
                        for(var element in value.children){
                          final res = StudentInformationModel.fromJson( jsonDecode(jsonEncode(element.value)));
                          if(res.studentId == studentIdEditingController.text) {
                            dbRef.child(element.key.toString()).update(model.toJson());
                          }
                        }
                        EasyLoading.showSuccess('Done');
                        ref.refresh(studentProvider);
                        const StudentList().launch(context);
                      });
                    },
                    child: Text('Save')),
              ],
